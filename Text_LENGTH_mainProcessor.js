    ...
    return new Promise((resolve) => {
      ...
      function step() {
        ...
        for (; i < end; i++) {
          ...
          if (len > globalState.globalMax) { globalState.globalMax = len; globalState.globalMaxWords.length = 0; globalState.globalMaxWords.push(word); } else if (len === globalState.globalMax) { globalState.globalMaxWords.push(word); }
          if (len < globalState.globalMin) { globalState.globalMin = len; globalState.globalMinWords.length = 0; globalState.globalMinWords.push(word); } else if (len === globalState.globalMin) { globalState.globalMinWords.push(word); }
        }
